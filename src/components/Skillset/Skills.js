...
export default function Skills() {
	...
	return (
		...
		>
			...
			<div className='flex flex-row justify-center items-center w-screen max-w-xl text-seashell text-xl mt-4 sticky top-0 h-20'>
				<button
			...
			<ul
				className={`my-12 grid grid-cols-2 w-full h-full mx-auto gap-x-4 gap-y-6 px-4 text-richblue-300 sm:grid-cols-4 sm:gap-x-1 ${
					skillCategory === 'Languages'
						? 'max-w-2xl'
						: ' md:grid-cols-5 lg:grid-cols-7 lg:gap-x-10 max-w-4xl'
				}`}
			>
